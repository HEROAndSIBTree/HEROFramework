...
public:
	...
	ull count_intersection(node u, const int num_chunk, const SIB_Tree_Node* tmp_vals);
	...
	ull helper(node u, node v, int u_id, int v_id, int current_level, SIB_Tree_Node* res, int& num_chunk);
	...
	ull get_intersection(node u, node v, SIB_Tree_Node* res, int &num_chunk);
	ull get_intersection(node u, const int ptr, const SIB_Tree_Node* tmp_vals, SIB_Tree_Node* res, int& num_chunk);
	...
	void create_tmp_index(int &num_chunk, SIB_Tree_Node* new_vals);
